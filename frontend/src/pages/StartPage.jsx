    ...
    <section className="page-container start-page">
      <div className="intro-card">
        ...
        <div className="intro-section">
          <h2>任務介紹與操作流程說明</h2>
          <p>
            實驗流程約 20 分鐘，包含閱讀任務說明、完成 5 個投資情境任務、每題查看模型預測結果與可選擇查看解釋資訊，最後做出投資決策與決策理由。
          </p>
          <p>
        ...
        <div className="flow-card">
          <h2>實驗流程</h2>
          <p>
            你將依序完成 5 個模擬投資任務。每個任務都會先給你一段投資故事背景與市場資訊，接著顯示模型預測結果、投資建議與信心分數。你可以自行決定是否點開模型解釋、重要特徵、風險提示與驗證建議。最後，你需要選擇自己的投資決策，並選擇一個最主要的決策理由。
          </p>
        </div>
        <div className="terms-grid" aria-label="介面名詞說明">
          <div>
            <strong>AI 預測</strong>
            <span>系統根據資料推測明日可能走勢。</span>
          </div>
          <div>
            <strong>信心分數</strong>
            <span>模型對該次判斷的把握程度，但不代表一定正確。</span>
          </div>
          <div>
            <strong>模型解釋</strong>
            <span>為什麼這樣判斷。</span>
